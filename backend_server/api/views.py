...
# import io
# from PIL import Image
# from backend.plant_model import predict, PLANT_NAMES

# @csrf_exempt
# def predict_plant(request):
#     print("🟢 PREDICT_PLANT ENDPOINT CALLED")

#     try:
#         body = json.loads(request.body)

#         # Accept both "image" and "image_base64"
#         img_base64 = body.get("image") or body.get("image_base64")
#         if not img_base64:
#             return JsonResponse({"error": "No image provided"}, status=400)

#         print(f"Step 1: Received base64 string length: {len(img_base64)}")

#         # Decode image
#         image = Image.open(io.BytesIO(base64.b64decode(img_base64))).convert("RGB")
#         print(f"Step 2: Image opened successfully (size={image.size})")

#         # ✅ Run prediction (model loaded once globally)
#         result_index = predict(image)
#         plant_name = PLANT_NAMES[result_index]
#         print(f"🌱 Prediction complete: {plant_name}")

#         return JsonResponse({
#             "plant_index": result_index,
#             "plant_name": plant_name
#         })
